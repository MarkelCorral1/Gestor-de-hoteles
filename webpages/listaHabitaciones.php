...
<body style="font-family: 'Roboto';">
    ...
    <div class="container my-4">
        <h3 class="text-center display-5 fw-bold text-uppercase my-4"><?= $hotel->getCiudad() ?>,
            <?= $hotel->getPais() ?>
        </h3>
        <div class="row">
            ...
            <main class="col-12 col-md-10">
                ...
                <div id="info-categoria"
                    class="mt-5 p-4 bg-white rounded shadow-sm border-start border-4 border-danger">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <h2 id="cat-titulo" class="display-6 fw-bold text-uppercase m-0" style="font-family: 'Open Sans';">Stroll</h2>
                        ...
                        <div class="text-end">
                            ...
                            <span id="cat-precio" class="h1 fw-bold text-dark">500</span><span
                                class="h3 fw-bold">€</span>
                    ...
                    <div class="row">
                        ...
                        <br><br>
                        <!-- Boton modal reserva -->
                        <button type="button" class="btn btn-book mt-3" data-bs-toggle="modal"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Reserva - <?= $hotel->getCiudad() ?>,
                        <?= $hotel->getPais() ?>
                    </h1>
                ...
                <div class="modal-body">
                    ...
                    <div id="reserva-paso-1">
                        <form id="form-reserva">
                            <input type="hidden" name="id_hotel" id="reserva-id-hotel"
                                value="<?= $hotel->getId_hotel() ?>">
                            <input type="hidden" name="id_categoria" id="reserva-id-categoria" value="1">
                            <label for="reserva-fecha-inicio">Fecha de entrada</label>
                            <div class="mb-3"><input type="date" name="fecha_inicio" class="form-control"
                                    id="reserva-fecha-inicio" required></div>
                            <label for="reserva-fecha-final">Fecha de salida</label>
                            <div class="mb-3"><input type="date" name="fecha_final" class="form-control"
                                    id="reserva-fecha-final" required></div>
                            ...
                            <button type="button" class="btn btn-primary" onclick="fetchDisponibilidad()">Comprobar
                        ...
                        <form action="<?= PHP_URL ?>/crearReserva.php" method="post">
                            ...
                            <div class="d-flex gap-2">
                                <button type="button" class="btn btn-outline-secondary"
                                    onclick="volverAPaso1()">Modificar</button>
