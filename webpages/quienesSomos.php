        ...
        <section class="py-5" style="background:linear-gradient(135deg, #610000 0%, #0d0d0d 100%)">
            <div class="container py-5 text-center">
                ...
                <div class="d-flex gap-3 justify-content-center">
                    <a href="dashboard.php" class="btn btn-outline-danger btn-lg px-4 rounded-pill">Explorar Hoteles</a>
                    <a href="contacto.php" class="btn btn-outline-light btn-lg px-4 rounded-pill">Contactar</a>
                </div>
            </div>
        </section>
